...
const Signup = () => {
  ...
  const Signup = async (e) => {
    ...
    try {
      ...
      console.log("Calling handleUserActions...");
      const handsend = await sendWelcomeEmail(user.email)
      console.log("hand send"+handsend,user.email);
      console.log("handleUserActions completed.");
